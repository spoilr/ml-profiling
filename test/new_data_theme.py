...
if __name__ == "__main__":
	...
	if tech == 'lr':
		error_rate, (hp, hr, hf), (cp, cr, cf) = fusion(lr, training_data, training_targets, testing_data, testing_targets, fusion_algorithm)
		...
		error_rate, (hp, hr, hf), (cp, cr, cf) = fusion(svm_for_features_fusion, training_data, training_targets, testing_data, testing_targets, fusion_algorithm, ind=True)
