...
ideology = ['MilExp', 'Ideology', 'Religion', 'AwareGriev', 'AwareIdeo', 'IdeoChangeInt', 'ReligChangeInt', 'Legitimise', 'WideGroup', 'Tipping', 'LocationNature', 'LocPubPriv', 'Contradict', 'BeliefChange', 'TargetGroup', 'RecruitNetGroup', 'Propaganda', 'OwnProp', 'PossessStories']
